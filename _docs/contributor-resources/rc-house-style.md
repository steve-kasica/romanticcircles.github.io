...
●  If workable, remove any numbering from headings within the text; since our transforms will automatically number paragraphs within the essay, ideally we don’t want two numbering systems within a single essay. If sections must be numbered, use Roman numerals.
All essays should be under 5,000 words and all abstracts should be under 150 words. 

capitalization
●  Enforce headline-style capitalization across all titles and heads (excepting foreign titles; follow CMOS 11.6). RC style, following CMOS 8.165 and 14.97, is to consistently enforce headline-style capitalization across all English-language titles from the Romantic period forward. In the case that a specific RC edition warrants enforcing sentence-style capitalization across multiple older titles, query the editors.
...
●  Follow CMOS 5.72 on the use of “a” or “an” before a vowel: go by sound (“a historical treatise”; “an hour ago”; “a eulogy”; “an X-Files episode”).
...
When a note combines a citation with commentary, the source comes first. A period usually separates the citation from the commentary. E.g., (1. Shakespeare, Julias Caesar, act 3, sc. 1. Caesar’s claim of constancy should be taken with a grain of salt.)
All notes should be converted to MS Word–linked endnotes (not footnotes) to ensure successful XML conversion.
