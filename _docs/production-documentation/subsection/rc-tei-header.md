  ...
  <teiHeader>
        <fileDesc>
            <titleStmt>
                ...
                <title type="subordinate">VOLUME TAG/SUBTITLE</title> <!-- This will change based on site section; for editions, "A Romantic Circles Electronic Edition -->
                ...
                <editor role="editor">VOLUME/EDITION EDITOR(S)</editor> <!-- Repeat this line for multiple editors -->
                ...
                <!-- In the following, keep only the relevant section editor -->
                <respStmt>
                    <resp>Praxis Editor</resp>
                    <name>Brian McGrath</name>
                </respStmt>
                <respStmt>
                    <resp>Editions Editor</resp>
            ...
            <publicationStmt>
                ...
                <availability status="free">
                    <p>Material from the Romantic Circles Website may not be downloaded, reproduced or disseminated in any manner without authorization unless it is for purposes of criticism, comment, news reporting, teaching, and/or classroom use as provided by the Copyright Act of 1976, as amended.</p>
                    <p>Unless otherwise noted, all Pages and Resources mounted on Romantic Circles are copyrighted by the author/editor and may be shared only in accordance with the Fair Use provisions of U.S. copyright law. Except as expressly permitted by this statement, redistribution or republication in any medium requires express prior written consent from the author/editors and advance notification of Romantic Circles. Any requests for authorization should be forwarded to Romantic Circles:&gt; <address>
                    ...
                    <p>Users are not permitted to download these texts and images in order to mount them on their own servers. It is not in our interest or that of our users to have uncontrolled subsets of our holdings available elsewhere on the Internet. We make corrections and additions to our edited resources on a continual basis, and we want the most current text to be the only one generally available to all Internet users. Institutions can, of course, make a link to the copies at Romantic Circles, subject to our conditions of use.</p>
                </availability>
                <!-- CHANGE IDNO (file identifiers). MAKE SURE THAT THE "EDITION" LINE MATCHES THE FILE NAME -->
                <idno type="edition">SECTION.YEAR.VOLUME-ABBREV.AUTHORLASTNAME</idno>
                <idno type="resource">VOLUME-ABBREV [same as above]</idno>
            </publicationStmt>
            <sourceDesc>
                <biblStruct>
                    <analytic>
                        ...
                        <ptr
                            target="SECTION/VOLUME-ABBREV/SECTION.YEAR.VOLUME-ABBREV.AUTHORLASTNAME.html"
                        />
                    </analytic>
                    <!-- CHANGE TITLES -->
                    <monogr>
